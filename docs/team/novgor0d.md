...
- **Command History (`history`):** Records all commands entered in the session, including failed ones. Supports `history N` and `history -c` to clear.
